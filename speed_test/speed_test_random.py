...
for num in num_envs:
    ...
    sps_list.append(sps)
    print(f"socialmeta, Num Envs: {num}, Total Time (s): {total_time}")
    print(f"socialmeta, Num Envs: {num}, Total Steps: {config['NUM_STEPS'] * config['NUM_ENVS']}")
    print(f"socialmeta, Num Envs: {num}, SPS: {sps}")
