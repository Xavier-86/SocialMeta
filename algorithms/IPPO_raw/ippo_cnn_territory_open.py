...
import socialmeta
from socialmeta.wrappers.baselines import LogWrapper, SVOLogWrapper
import hydra
...
def single_run(config):
    ...
    wandb.init(
        ...
        name=f'ippo_cnn_territory_open'
    )
...
@hydra.main(version_base=None, config_path="config", config_name="ippo_cnn_territory_open")
def main(config):
    if config["TUNE"]:
        tune(config)
    else:
