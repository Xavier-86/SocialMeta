...
import socialmeta
from socialmeta.wrappers.baselines import MAPPOWorldStateWrapper, LogWrapper
import hydra
...
def single_run(config):
    ...
    wandb.init(
        ...
        name=f'mappo_cnn_harvest_common_partnership'
    )
...
@hydra.main(version_base=None, config_path="config", config_name="mappo_cnn_harvest_common_partnership")
def main(config):
    if config["TUNE"]:
        tune(config)
    else:
